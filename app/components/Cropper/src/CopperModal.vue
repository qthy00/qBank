          ...
          <div :class="`${prefixCls}-toolbar`">
            ...
            <el-space>
              <el-tooltip :content="t('cropper.btn_reset')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('reset')">
                  <Icon name="ep:refresh-right" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_rotate_left')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('rotate', -45)">
                  <Icon name="mdi:rotate-left-variant" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_rotate_right')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('rotate', 45)">
                  <Icon name="mdi:rotate-right-variant" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_scale_x')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('scaleX')">
                  <Icon name="mdi:arrow-left-right" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_scale_y')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('scaleY')">
                  <Icon name="mdi:arrow-up-down" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_zoom_in')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('zoom', 0.1)">
                  <Icon name="ep:zoom-in" class="mr-1px" />
                </el-button>
              </el-tooltip>
              <el-tooltip :content="t('cropper.btn_zoom_out')" placement="bottom">
                <el-button type="primary" size="small" :disabled="!src" @click="handlerToolbar('zoom', -0.1)">
                  <Icon name="ep:zoom-out" class="mr-1px" />
                </el-button>
              </el-tooltip>
            </el-space>
          </div>
